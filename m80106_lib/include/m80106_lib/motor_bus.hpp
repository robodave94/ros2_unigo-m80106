 ...
 *
 * Default PID:VID: FT4232H USB-to-RS485 adapter  →  "0403:6011"
 *
 * Usage — auto-discover:
 * @code
 *   m80106::MotorBus bus("0403:6011");
 *   if (!bus.isConnected()) {
...
namespace m80106
{
    ...
    struct BusInfo
    {
        ...
        std::string hardware_id; ///< From sysfs, e.g. "USB VID:PID=0403:6011 SNR=..."
    ...
    public:
         ...
         * exception is thrown.
         *
         * @param pidvid  PID:VID string, e.g. "0403:6011" for FT4232H.
         */
        explicit MotorBus(const std::string &pidvid = "0403:6011")
        {
            try
            {
        ...
        /// Sysfs hardware_id string, e.g. "USB VID:PID=0403:6011 SNR=...".
